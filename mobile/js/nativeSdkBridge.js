 ...
 * Designed to be used with mobile sample interfaces. See {@tutorial Getting Started on Mobile} for more details.
 *
 * The quotefeed cannot be defined in native mobile but in javascript. All this function does is allow the parameters of a quotefeed
 * to be set. If you attach a quotefeed using this function do not accidently attach another quotefeed in your html template.
 *
 * Make sure the parameter names match up with the {@link CIQ.ChartEngine#attachQuoteFeed}.
 * @param {String}[params] JSON string that defines all the optional parameters for {@link CIQ.ChartEngine#attachQuoteFeed}.
 * @memberof CIQ.MobileBridge
 */
