 ...
 *
 * This class exists to support jQuery-like methods within the existing web components. New web
 * components should be written using native accessors instead of the methods of this class.
 *
 * @since 8.1.0
 */
class Faquery {
